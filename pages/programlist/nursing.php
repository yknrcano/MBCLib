...
<body>
    ...
    <div class="admission-banner">
        <h1>Nursing</h1>
        <img src="assets/bgnurse.jpg" alt="background">
    </div>
    ...
    <div class="program-content">
        <div class="program-box">
            <div class="program-detail" id="description">
                ...
                <p>The Nursing program at Marie-Bernarde College is designed to prepare students for a rewarding career in the healthcare field. Our comprehensive curriculum combines theoretical knowledge with practical skills, ensuring that graduates are well-equipped to provide high-quality patient care.</p>
            </div>

            <div class="program-detail" id="opportunities">
                <h3>Career Opportunities:</h3>
                <p>Graduates of the Nursing program can pursue various career paths, including:</p>
                <ul>
                    <li>Registered Nurse (RN)</li>
                    <li>Nurse Practitioner (NP)</li>
                    <li>Clinical Nurse Specialist (CNS)</li>
            ...
            <div class="program-detail" id="features">
                <h3>Key Features:</h3>
                <ul>
                    <li>Comprehensive curriculum covering all aspects of nursing care</li>
                    <li>Hands-on clinical training in partnership with leading healthcare facilities</li>
                    <li>Experienced faculty with real-world nursing experience</li>
                    <li>Focus on patient-centered care and ethical practices</li>
                    <li>Opportunities for specialization in areas such as pediatrics, geriatrics, and critical care</li>
                </ul>
            </div>
