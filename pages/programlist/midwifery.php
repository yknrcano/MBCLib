...
<body>
    ...
    <div class="admission-banner">
        <h1>Midwifery</h1>
        <img src="assets/bgmidwife.jpg" alt="background">
    </div>
    ...
    <div class="program-content">
        <div class="program-box">
            <div class="program-detail" id="description">
                ...
                <p>The Graduate in Midwifery is a 2-year program that aims to provide competency and adequate knowledge, training and skills in areas that includes clinical practicum in foundations of midwifery, normal obstetrics and care of the newborn, introduction to critical obstetrics, basic care of infants and feeding, basic family planning, primary health care and midwifery ethics, law and practice. Throughout the program, students engage in hands-on learning experiences through supervised clinical rotations in various healthcare settings, including hospitals, birthing centers, and community clinics.</p>
            </div>
            ...
            <div class="program-detail" id="features">
                <h3>Key Features:</h3>
                <ul>
                    <li>Comprehensive curriculum covering all aspects of midwifery care</li>
                    <li>Hands-on clinical experience in diverse healthcare settings</li>
                    <li>Experienced faculty with expertise in midwifery and healthcare</li>
                    <li>State-of-the-art simulation labs for practical training</li>
                    <li>Opportunities for research and community engagement</li>
                    <li>Strong emphasis on ethical practice and patient-centered care</li>
                </ul>
            </div>
