...
<body>
    ...
    <div class="admission-banner">
        <h1>LET Program</h1>
        <img src="assets/bglet.jpg" alt="background">
    </div>
    ...
    <div class="program-title">
        <h2>Licensure Examination for Teachers (LET)</h2>
    </div>
    ...
    <div class="program-content">
        <div class="program-box">
            <div class="program-detail" id="description">
                ...
                <p>The Philippine Teachers Professionalization Act of 1994 requires all persons engaged in teaching, supervision and administration of all elementary and secondary schools in the country to pass the Licensure Examination for Teachers (LET). Hence, this program aims to allow applicant that hold a Bachelor of Arts/Science degree from a higher education institution that is recognized by the Philippine Commission on Higher Education to a non-degree program that can earn the 18-unit professional education requirement to be allowed to take the LET which is administered by the Professional Regulatory Commission (PRC).</p>
            </div>

            <div class="program-detail" id="opportunities">
                <h3>Career Opportunities:</h3>
                <p>Graduates of the LET program can pursue various career paths, including:</p>
                <ul>
                    <li>Licensed Professional Teacher (LPT)</li>
